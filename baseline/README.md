...
- Download the training dataset from [here](https://www.synapse.org/Synapse:syn74274097/datasets/) and unzip it into the root of this repository (```2026_challenge/```)
